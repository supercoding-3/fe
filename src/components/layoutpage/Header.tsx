...
import { setLogout } from '../../redux/reducers/user'; // 로그아웃 액션
...
const Header: React.FC = () => {
    ...
    const profileImage = useSelector((state: { user: UserState }) => state.user.profileImage);
    ...
    const handleLogout = async () => {
        try {
            await axios.post('/user/logout'); // 서버로 로그아웃 요청
            dispatch(setLogout()); // Redux 상태 업데이트
            alert('로그아웃 되었습니다.');
            closeDropdown();
        } catch (err) {
